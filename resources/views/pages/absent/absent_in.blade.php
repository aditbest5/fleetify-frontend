                    ...
                    <div class="widget-content widget-content-area">
                        <form>
                            <div class="form-group mb-4">
                                <label for="exampleFormControlInput2">Jam Masuk</label>
                                <input type="datetime-local" id="clockIn" class="form-control" name="clock_in" readonly />
                            </div>
                            <div class="form-group mb-4">
...
<script>
    ...
    async function saveAbsent() {
        try {
            ...
            const clock_in = document.querySelector('input[name="clock_in"]').value;
            const date_attendance= document.getElementById('dateAttendance').value;

            // Validasi input
            if (!clock_in || !date_attendance) {
            ...
            const response = await fetch('http://127.0.0.1:8100/api/attendance/absent_in', {
                method: 'POST',
                headers: {
            ...
            if (data.response_code === '200') {
                ...
                window.location.href="/absent-in"
            } else {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('clockIn').value = currentDateTime;
